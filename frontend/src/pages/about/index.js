    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/russinArtem/foodgram" className={styles.textLink} target="_blank" rel="noopener noreferrer">GitHub</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/russinArtem" className={styles.textLink} target="_blank" rel="noopener noreferrer">russinArtem</a>
            </p>
          </div>
        </aside>
      </div>
